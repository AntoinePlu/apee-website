...
export default function VoiceInputExperiment() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <main className="mx-auto max-w-2xl px-6 py-24 sm:py-32">
        ...
        <p className="text-[var(--muted)] mb-12">
          A pill-shaped button that expands into a live recording indicator on
          click — animated frequency bars and a running timer, then collapses
          cleanly when stopped.
        </p>

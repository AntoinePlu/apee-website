...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[22rem] -skew-y-[8deg] select-none flex-col justify-between rounded-xl border-2 border-border bg-muted/70 px-4 py-3 backdrop-blur-sm transition-all duration-700",

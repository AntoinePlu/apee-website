...
// ---------------------------------------------------------------------------
// ColorOrb CSS — injected once into <head> to avoid styled-jsx dependency
// ---------------------------------------------------------------------------

const COLOR_ORB_STYLES = `
  @property --angle {
    syntax: "<angle>";
    inherits: false;
    initial-value: 0deg;
...
const ColorOrb: React.FC<OrbProps> = ({
  ...
  React.useEffect(() => {
    if (typeof window !== "undefined" && !orbStylesInjected) {
      orbStylesInjected = true
      const style = document.createElement("style")
      style.innerHTML = COLOR_ORB_STYLES
